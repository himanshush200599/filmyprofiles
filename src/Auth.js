...
firebase.initializeApp(config);
 ...
 facebook(){
   ...
   render(){
    ...
    <a className="navbar-brand" href="#"><img src='./images/logo.PNG' className="img-responsive" alt='logo' /></a>
  ...
  <div className='row'>
    <div className='col-md-8 col-lg-8 col-sm-12 col-xs-12'>
      <div>
      <img src='./images/image_main.png' className="imgMain img-responsive" alt='road-scene' />
      </div>
  </div>
     ...
     <div className ='col-md-8 col-lg-4 col-sm-12 col-xs-12'>
       <div id='box'>
       <div>
        <h2>JOIN US</h2>
        </div>
  ...
  <footer className='footer'>
    ...
    <div className='col-md-8' >
     <img src='./images/bottom.PNG' className='img-responsive' alt='bottom logo' />
    </div>
